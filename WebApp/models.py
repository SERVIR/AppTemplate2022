...
class Organization(models.Model):
    ...
    organization_address = models.CharField(max_length=100, help_text="Organization physical address - Optional", blank=True)
    organization_city = models.CharField(max_length=100, help_text="Organization City - Optional", blank=True)
    organization_country = models.CharField(max_length=2, help_text="Organization Country ISO Code - Optional", blank=True)
...
class Station(models.Model):
    ...
    station_elev = models.FloatField(help_text="Station Elevation in meters above sea level - Optional", blank=True, null=True)
    ...
    station_year_established = models.IntegerField(help_text="Year the station was established - Optional", blank=True, null=True)
